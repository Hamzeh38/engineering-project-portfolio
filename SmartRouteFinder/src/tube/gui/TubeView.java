	...
	private int[]ylines={56,86,112,140,56,86,112,140};	
	 ...
	 public void init(TermList selection) {
	  ...
	  public static void main(String[] args) {
		  TubeView tv=new TubeView(new Network());
		  tv.show(null);
	  }
	  ...
	  */	  
	  public void clear(){
		...
		/* -----------------------------------------------------------
		 * returns the angle <AB,AC>
		 * -----------------------------------------------------------
		 */
		
		public double angle(String sA, String sB, String sC) {
			Station s0=getStation(sA);
			Station s1=getStation(sB);
			Station s2=getStation(sC);
			if ((s0==null)||(s1==null)||(s2==null)) {
				System.out.println("Unknown station name");
				System.exit(-1);				
			}
			return s0.angle(s1,s2);
		}
